#
#  Be sure to run `pod spec lint SNDBManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/snlo/SNDBManager.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "SNDBManager/SNDBManager/*.{h,m}"
